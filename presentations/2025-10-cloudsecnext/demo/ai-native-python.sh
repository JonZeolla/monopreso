...
docker_hub="https://hub.docker.com/repository/docker/jonzeolla/cloudsecnext25/general"
echo "# Ok, and now let's look at ${docker_hub}"
open "${docker_hub}"

export ALLOW_FORCE_PUSH=true
rm -rf cloudsecnext25 2>/dev/null || true
pe "uvx --with gitpython cookiecutter gh:zenable-io/ai-native-python project_name=cloudsecnext25"


github=https://github.com/JonZeolla/cloudsecnext25
...
release="https://github.com/JonZeolla/cloudsecnext25/actions/workflows/release.yml"
